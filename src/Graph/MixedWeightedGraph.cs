...
namespace Graph
{
        ...
        where TVertex : IComparable<TVertex>
    {
        ...
        public MixedWeightedGraph(
            IEnumerable<TVertex> vertices,
            IEnumerable<KeyValuePair<TVertex, TVertex>> directedEdges,
            IEnumerable<KeyValuePair<TVertex, TVertex>> undirectedEdges,
            IDictionary<KeyValuePair<TVertex, TVertex>, TWeight> directedWeights,
            IDictionary<KeyValuePair<TVertex, TVertex>, TWeight> undirectedWeights) : this(vertices, directedEdges, undirectedEdges)
        {
